export default function Home() {
    ...
    <>
      ...
      <div>
        ...
        <div className="card-group">
          <div className="card">
            <img src="https://placehold.co/50" class="card-img-top" alt="..." />
  ...
  <div className="carousel-inner">
    <div className="carousel-item active" data-bs-interval="10000">
      <img src="https://placehold.co/100" class="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item" data-bs-interval="2000">
      <img src="https://placehold.co/150" class="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="https://placehold.co/120" class="d-block w-100" alt="..."/>
    </div>
  </div>
